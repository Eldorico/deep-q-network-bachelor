...
%    \vspace{1cm}
  ...
  \par TODO: faire en sorte que l'on comprenne que les objectifs ci-dessous correspondent au contexte, et qu'un jeu va être créé pour que l'agent évolue dans tout ceci
  ...
  \item Une fois les deux premières connaissances apprises, apprendre à jongler entre ces deux dernières afin de jouer convenablement au jeu. 
  \end{enumerate}
  ...
  \item Une fois des connaissances apprises, l'on doit pouvoir les sauvegarder afin de pouvoir les réutiliser pour la suite de l'apprentissage: une fois que l'agent a appris à éviter les ennemis ou attraper de la nourriture, il faut pouvoir faire en sorte de réutiliser ces connaissances sans avoir à les réapprendre à chaque fois que le programme démarre. 
  \end{itemize}
