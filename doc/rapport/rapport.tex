...
def reward_function(world):
  ...
  \par Ci dessous les histogrammes de l'agent en train d'apprendre à attraper la nourriture. 
   ...
   Malheureusement, cela a empiré la durée de l'apprentissage. Ci dessous le graphique du score en fonction du nombre d'épisodes. En bleu, le score pour un échantillon de taille $32$, en orange un échantillon de taille $32'000$.
